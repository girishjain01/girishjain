...
function Lokotarkibhavna() {
  const [userData, setUserData] = useState([]);

  useEffect(() => {
    
    const id = "Lokotarkibhavna_Page"; // यह आईडी वही है जिसे आप फेच करना चाहते हैं
    ...
    <div>
      {userData.map((user, index) => (
        <MantarComponent
          ...
          audio1={"/mp3/mangal-lagutma1.mp3"} // उदाहरण के लिए, आपको सही path डालना होगा
          audio2={audio2}
        />
      ))}
    </div>
