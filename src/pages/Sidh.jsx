...
function Sidh() {
  ...
  useEffect(() => {
    ...
    const id = "Sidh_Page"; // यह आईडी वही है जिसे आप फेच करना चाहते हैं
  ...
  const url = "/img/namo-siddhanm.jpg";
  const audio2 = "/mp3/sidhanam-1.mp3";
    ...
    <div>
      {userData.map((user, index) => (
        <MantarComponent
          ...
          audio1={"/mp3/sidhanam-1-1.mp3"} // उदाहरण के लिए, आपको सही path डालना होगा
          audio2={audio2}
        />
      ))}
    </div>
